var _cf = _cf || [],
    bmak = bmak && bmak.hasOwnProperty("ver") && bmak.hasOwnProperty("sed") ? bmak : {
        ...
        get_browser: function() {
            navigator.productSub && (bmak.psub = navigator.productSub), navigator.language && (bmak.lang = navigator.language), navigator.product && (bmak.prod = navigator.product), bmak.plen = navigator.plugins.length : -1;
        },
        gbrv: function() {
        ...
        cma: function(t, a) {
            try {
                if (1 == a && bmak.mme_cnt < bmak.mme_cnt_lmt || 1 != a && bmak.mduce_cnt < bmak.mduce_cnt_lmt) {
                    ...
                    void 0 !== e.isTrusted && false === e.isTrusted && (c += ",it0"), c += ";", bmak.me_vel = bmak.me_vel + bmak.me_cnt + a + i + n + o, bmak.mact = bmak.mact + c, bmak.ta += i;
                }
                1 == a ? bmak.mme_cnt++ : bmak.mduce_cnt++, bmak.me_cnt++, bmak.js_post && 3 == a && (bmak.aj_type = 1, bmak.bpd(), bmak.pd(true), bmak.ce_js_post = 1);
            } catch (t) {}
        },
        x2: function() {
            var t = bmak.ff,
            ...
            try {
                ...
                if (1 == a && bmak.pme_cnt < bmak.pme_cnt_lmt || 1 != a && bmak.pduce_cnt < bmak.pduce_cnt_lmt) {
                    ...
                    if (n && "mouse" != n.pointerType) {
                        ...
                        void 0 !== n.isTrusted && false === n.isTrusted && (i += ",0"), bmak.pe_vel = bmak.pe_vel + bmak.pe_cnt + a + r + o + m, bmak.pact = bmak.pact + i + ";", bmak.ta += r, 1 == a ? bmak.pme_cnt++ : bmak.pduce_cnt++;
                    }
                }
                1 == a ? bmak.pme_cnt++ : bmak.pduce_cnt++, bmak.pe_cnt++, bmak.js_post && 3 == a && e && (bmak.aj_type = 2, bmak.bpd(), bmak.pd(true), bmak.ce_js_post = 1);
            } catch (t) {}
        },
        ab: function(t) {
            if (null == t) return -1;
            ...
            try {
                ...
                if (bmak.ke_cnt < bmak.ke_cnt_lmt && e) {
                    ...
                    if (0 == bmak.isIgn(n)) {
                        ...
                        void 0 !== e.isTrusted && false === e.isTrusted && (u += ",0"), u += ";", bmak.kact = bmak.kact + u, bmak.ke_vel = bmak.ke_vel + bmak.ke_cnt + a + s + n + d + k, bmak.ta += s;
                    } else o = 0;
                }
                o && e && bmak.ke_cnt++, !bmak.js_post || 1 != a || 13 != n && 9 != n || (bmak.aj_type = 3, bmak.bpd(), bmak.pd(true), bmak.ce_js_post = 1);
            } catch (t) {}
        },
        cta: function(t, a) {
            try {
                if (1 == a && bmak.tme_cnt < bmak.tme_cnt_lmt || 1 != a && bmak.tduce_cnt < bmak.tduce_cnt_lmt) {
                    ...
                    void 0 !== e.isTrusted && false === e.isTrusted && (r += ",0"), bmak.tact = bmak.tact + r + ";", bmak.ta += m, bmak.te_vel = bmak.te_vel + bmak.te_cnt + a + m + n + o, bmak.doa_throttle = 0, bmak.dma_throttle = 0;
                }
                1 == a ? bmak.tme_cnt++ : bmak.tduce_cnt++, bmak.te_cnt++, bmak.js_post && 2 == a && bmak.aj_indx_tact < bmak.aj_lmt_tact && (bmak.aj_type = 5, bmak.bpd(), bmak.pd(true), bmak.ce_js_post = 1, bmak.aj_indx_tact++);
            } catch (t) {}
        },
        ...
        cdoa: function(t) {
            try {
                if (bmak.doe_cnt < bmak.doe_cnt_lmt && bmak.doa_throttle < 2 && t) {
                    ...
                    void 0 !== t.isTrusted && false === t.isTrusted && (m += ",0"), bmak.doact = bmak.doact + m + ";", bmak.ta += a, bmak.doe_vel = bmak.doe_vel + bmak.doe_cnt + a, bmak.doe_cnt++;
                }
        ...
        cdma: function(t) {
            try {
                if (bmak.dme_cnt < bmak.dme_cnt_lmt && bmak.dma_throttle < 2 && t) {
                    ...
                    void 0 !== t.isTrusted && false === t.isTrusted && (s += ",0"), bmak.dmact = bmak.dmact + s + ";", bmak.ta += a, bmak.dme_vel = bmak.dme_vel + bmak.dme_cnt + a, bmak.dme_cnt++;
                }
        ...
        startdoadma: function() {
            0 == bmak.doadma_en && window.addEventListener && (window.addEventListener("deviceorientation", bmak.cdoa, true), window.addEventListener("devicemotion", bmak.cdma, true), bmak.doadma_en = 1), bmak.doa_throttle = 0, bmak.dma_throttle = 0;
        },
        updatet: function() {
        ...
        bpd: function() {
            ...
            try {
                ...
                bmak.firstLoad ? bmak.np() : bmak.csh(), !bmak.hbCalc && (0 == bmak.js_post || bmak.aj_indx > 0) && (bmak.fm(), bmak.wgl(), bmak.hbCalc = true);
                var E = "";
        ...
        call_gp: function() {
            ...
            }) : t = new ActiveXObject("Microsoft.XMLHTTP"), t.open("GET", bmak.params_url, true), t.onreadystatechange = function() {
        ...
        apicall_bm: function(t, a, e) {
            ...
            void 0 !== window.XMLHttpRequest ? n = new XMLHttpRequest : void 0 !== window.XDomainRequest ? (n = new XDomainRequest, n.onload = function() {
                this.readyState = 4, this.onreadystatechange instanceof Function && this.onreadystatechange();
            }) : n = new ActiveXObject("Microsoft.XMLHTTP"), n.open("POST", t, a), void 0 !== n.withCredentials && (n.withCredentials = true);
        ...
        check_stop_protocol: function() {
            var t = bmak.get_stop_signals(),
                a = t[0];
            !bmak.rst && a > -1 && (bmak.ir(), bmak.rst = true);
            var e = t[1];
        ...
        calc_fp: function() {
            bmak.fpcf.fpVal(), bmak.js_post && (bmak.aj_type = 9, bmak.bpd(), bmak.pd(true));
        },
        listFunctions: {
            ...
            _setBm: function(t) {
                bmak.bm = t, bmak.bm ? (bmak.cf_url = (bmak.fsp ? "https:" : document.location.protocol) + "//" + document.location.hostname + "/_bm/_data", bmak.js_post = true) : bmak.params_url = (bmak.fsp ? "https:" : document.location.protocol) + "//" + document.location.hostname + "/get_params";
            },
            _setAu: function(t) {
...
if (function(t) {
        ...
        }, a.fpValstr = "-1", a.fpValCalculated = false, a.rVal = "-1", a.rCFP = "-1", a.cache = {}, a.td = -999999, a.clearCache = function() {
            a.cache = {};
        }, a.fpVal = function() {
            ...
            try {
                ...
                if (!a.sf4()) {
                    ...
                    if (n.width = 280, n.height = 60, n.style.display = "none", "function" == typeof n.getContext) {
                        ...
                        o.fillStyle = "rgb(102, 204, 0)", o.fillRect(100, 5, 80, 50), o.fillStyle = "#f60", o.font = "16pt Arial", o.fillText(t, 10, 40), o.strokeStyle = "rgb(120, 186, 176)", o.arc(80, 10, 20, 0, Math.PI, false), o.stroke();
                        var m = n.toDataURL();
                        e = 0;
                        for (var r = 0; r < m.length; r++) {
